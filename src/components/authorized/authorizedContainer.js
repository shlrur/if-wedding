    ...
    render() {
        ...
        return (
            <div className="authorized-container">
                ...
                <PrivateRoute exact path={`${this.props.match.url}/preview`} component={Preview} />
                <PrivateRoute exact path={`${this.props.match.url}/settings/coupleinform`} component={CoupleInformation} />
            </div>
        );
    }
